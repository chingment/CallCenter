...
namespace WebAdmin.Controllers.Biz
{
    ...
    public class ObBatchController : OwnBaseController
    {
        ...
        public CustomJsonResult InitDataToAddByFile(string merchantId)
        {
        ...
        public CustomJsonResult AddByFile(RopObBatchAddByFile rop)
        {
            ...
            var belongUser = CurrentDb.SysMerchantUser.Where(m => m.MerchantId == rop.MerchantId && m.Id == rop.BelongerId).FirstOrDefault();
            ...
            result = AdminServiceFactory.ObBatch.AddByFile(this.CurrentUserId, rop);
